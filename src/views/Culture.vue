<template>
  <div class="news-page">
    ...
    <section class="n_banner">
      ...
      <div class="top">
        <div class="wp">
          <h3 data-aos="fade-up" data-aos-delay="200">企业文化</h3>
          <p data-aos="fade-up" data-aos-delay="600">了解华苏企业文化</p>
        </div>
      </div>
        ...
        <div class="wp">
          <ul>
            <li :class="{ on: currentTab === 'corporate' }">
              <router-link to="/culture/corporate" title="企业文化">企业文化</router-link>
            </li>
            <li :class="{ on: currentTab === 'history' }">
              <router-link to="/culture/history" title="发展历程">发展历程</router-link>
            </li>
          </ul>
        </div>
      </section>
    ...
    <section id="m_n_nav">
      ...
      <div id="sub_nav_content" :class="{ show: showMobileNav }">
        <dl>
          ...
          <dt :class="{ on: currentTab === 'history' }">
            <router-link to="/culture/history" title="发展历程">发展历程</router-link>
          </dt>
        </dl>
      </div>
    ...
    <section class="n_container">
      <CorporateCulture v-if="currentTab === 'corporate'" />
...
import CorporateCulture from '@/components/culture/CorporateCulture.vue'
import DevelopmentHistory from '@/components/culture/DevelopmentHistory.vue'
...
export default {
  ...
  computed: {
    currentTab() {
      ...
      return this.$route.params.tab || 'corporate'
    }
  },
  mounted() {
    // 初始化AOS动画
  ...
  methods: {
    ...
    getCurrentTitle() {
      ...
      return titles[this.currentTab] || '企业文化'
    },
    initAOS() {
      // 确保AOS库已加载
      if (window.AOS) {
